...
int  main(){
	...
	token[7].token_number = 37; token[8].token_number = 38; token[9].token_number = 33; token[10].token_number = 3;
	token[11].token_number = 21; token[12].token_number = 3; token[13].token_number = 34; 
